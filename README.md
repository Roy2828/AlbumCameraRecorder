...
#### Step 2. Add the dependency
	...
	dependencies {
	     ...
	     implementation 'com.github.Roy2828.AlbumCameraRecorder:combined:1.1.85X'

	     // Public library, if not using the combined library above
	     implementation 'com.github.Roy2828.AlbumCameraRecorder:common:1.1.85X'
	     // core lib, call display album, screen recording, recording, etc
         implementation 'com.github.Roy2828.AlbumCameraRecorder:multilibrary:1.1.85X'
         ...
         implementation 'com.github.Roy2828.AlbumCameraRecorder:progresslibrary:1.1.85X'

         // use it with editing pictures
	     implementation 'com.github.Roy2828.AlbumCameraRecorder:imageedit:1.1.85X'
	     // For editing video
	     implementation 'com.github.Roy2828.AlbumCameraRecorder:videoedit:1.1.85X'
	}
